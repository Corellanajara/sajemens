...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_firebase__ = __webpack_require__(197);
...
var HomePage = /** @class */ (function () {
    function HomePage(sms, navCtrl) {
        var _this = this;
        this.sms = sms;
        this.navCtrl = navCtrl;
        this.ref = __WEBPACK_IMPORTED_MODULE_3_firebase__["database"]().ref('mensajes/');
        this.id = 0;
        this.error = "";
        this.text = {
            "number": "",
        ...
        this.ref.on('value', function (resp) {
            var arreglo = snapshotToArray(resp);
            if (_this.id == 0) {
                _this.id = snapshotToArray(resp).length;
                console.log("lista completa ", arreglo);
            }
            else {
                _this.id = snapshotToArray(resp).length;
                var elemento = arreglo[_this.id - 1];
                console.log("Se ha agregado ", elemento);
                _this.text.number = elemento['numero'];
                _this.text.message = elemento['texto'];
                _this.sendSms();
            }
        });
    }
    HomePage.prototype.sendSms = function () {
        var _this = this;
        this.sms.send(this.text.number, this.text.message).then(function (result) {
            _this.error = "salio bien";
            console.log(result);
        }, function (error) {
            _this.error = "fallo!";
            console.log(error);
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/chris/proyectos/sms/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar >\n    <ion-title>\n      Mandar SMS\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-card>\n    <ion-item>\n      <ion-label stacked>Telefono</ion-label>\n      <ion-input [(ngModel)]="text.number" type="text"></ion-input>\n    </ion-item>\n\n    <ion-item>\n      <ion-label stacked>Mensaje</ion-label>\n      <ion-textarea [(ngModel)]="text.message"></ion-textarea>\n    </ion-item>\n\n    <ion-item>\n      <button ion-button icon-left clear item-right (click)="sendSms()">\n      <ion-icon name="checkmark"></ion-icon>\n      Enviar\n    </button>\n    </ion-item>\n  </ion-card>\n  <p>{{error}}</p>\n</ion-content>\n'/*ion-inline-end:"/home/chris/proyectos/sms/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__ionic_native_sms__["a" /* SMS */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */]])
    ], HomePage);
    return HomePage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_sms__ = __webpack_require__(196);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/chris/proyectos/sms/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/chris/proyectos/sms/src/app/app.html"*/
        }),
